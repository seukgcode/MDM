...
if __name__ == '__main__':
    ...
    parser.add_argument('--meta_interval', type=int, default=10000, help='save step')
    ...
    Model_FILE = f"diffugen_{args.dataset}_h{args.hidden_dim}_lr{args.lr}" \
    ...
    COMMANDLINE = f" OPENAI_LOGDIR={Model_FILE}  " \
                  ...
                  f"--meta_interval {args.meta_interval} " \
    ...
    print(COMMANDLINE)
    #  OPENAI_LOGDIR=diffusion_models/diffugen_CC_h128_lr0.0001_t2000_sqrt_lossaware_seed102_CC20221201-11:46:28  TOKENIZERS_PARALLELISM=false python train.py   --checkpoint_path diffusion_models/diffugen_CC_h128_lr0.0001_t2000_sqrt_lossaware_seed102_CC20221201-11:46:28 --dataset CC --data_dir datasets/CC --vocab bert --use_plm_init no --lr 0.0001 --batch_size 2048 --microbatch 64 --diffusion_steps 2000 --noise_schedule sqrt --schedule_sampler lossaware --resume_checkpoint none --seq_len 128 --hidden_t_dim 128 --seed 102 --hidden_dim 128 --learning_steps 140000 --save_interval 20000 --config_name bert-base-uncased --notes CC20221201-11:46:28
